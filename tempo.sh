...
# Adapted from https://gitlab.com/tezos/tezos/raw/master/scripts/alphanet.sh
# with the addition of Tempo as a network option
...
docker_base_dir="$HOME/.tezos-tempo"
docker_image=tezos/tezos:mainnet
docker_compose_base_name=tempo
default_port=17700
